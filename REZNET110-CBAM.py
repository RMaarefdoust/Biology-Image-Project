...
# Custom ResNet110 with CBAM blocks
...
def resnet110_cbam(num_classes):
    return ResNetCBAM(BasicBlockCBAM, [18, 18, 18], num_classes)
...
# Load the custom ResNet110 model with CBAM
model = resnet110_cbam(num_classes=len(train_dataset.class_to_idx)).to(device)
