...
if __name__ == '__main__':
    ...
    class_weights = torch.tensor([1.0, 1.8, 2.0, 1.0, 1.0], dtype=torch.float32)  # Higher weights to class 1 and 2
    ...
    if correct / total > best_test:
        best_test = correct/total
        torch.save(model.state_dict(), f'./CNNCBAM.pth')
print(best_test, best_val)